...
const tablesSchema = __schema({
  ...
  highscore: __table({
    name: 'highscore',
    indexes: [
      { accessor: 'byScore', name: 'highscore_score_idx_btree', algorithm: 'btree', columns: [
        'score',
      ] },
      { accessor: 'user_id', name: 'highscore_user_id_idx_btree', algorithm: 'btree', columns: [
        'userId',
      ] },
    ],
    constraints: [
      { name: 'highscore_user_id_key', constraint: 'unique', columns: ['userId'] },
    ],
  }, HighscoreRow),
  preference: __table({
    name: 'preference',
    indexes: [
      { accessor: 'pair_id', name: 'preference_pair_id_idx_btree', algorithm: 'btree', columns: [
        'pairId',
      ] },
    ],
    constraints: [
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("vote_pair", VotePairReducer),
);
